...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Dashboard siempre empieza limpio — el usuario elige el rango
  // No restaurar sesión ni cargar automáticamente
  clearAllStorage(); // limpiar IDB y localStorage
});
...
function updateKPIs(resumen, todosLosRegistros) {
  ...
  if (esModoUnDia) {
    ...
    document.getElementById("kpiPresentePct").textContent = `${total ? Math.round(presentes/total*100) : 0}% del total`;
    document.getElementById("kpiAusentes").textContent    = ausentes;
    document.getElementById("kpiAusentePct").textContent  = `${total ? Math.round(ausentes/total*100) : 0}% del total`;
    ...
    document.getElementById("kpiDiasMulti").textContent     = `en ${dias.length} día(s)`;
          ...
          <table style="width:100%; border-collapse:collapse;">
            <thead>
              <tr style="background:#f0fbe6;">
                ...
                <th style="padding:10px 16px; text-align:center; font-family:'JetBrains Mono',monospace; font-size:10px; letter-spacing:1.5px; color:#8ba869; text-transform:uppercase; font-weight:700">Inscritos</th>
